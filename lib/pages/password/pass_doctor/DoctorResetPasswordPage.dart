...
class Doctorresetpasswordpage extends StatefulWidget {
  final String email;
  ...
  @override
  _DoctorresetpasswordpageState createState() =>
      _DoctorresetpasswordpageState();
}

class _DoctorresetpasswordpageState extends State<Doctorresetpasswordpage> {
  ...
  Future<void> _resetPassword() async {
    ...
    try {
      final response = await http.put(
        Uri.parse('$baseUrl1/doctors/change-password-after-otp'),
