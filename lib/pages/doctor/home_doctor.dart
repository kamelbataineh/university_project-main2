...
class _HomeDoctorPageState extends State<HomeDoctorPage> with SingleTickerProviderStateMixin {
  int _selectedIndex = 0;
  late AnimationController _controller;
  String doctorName = 'Doctor'; // لاحقًا يمكن fetch من API
  ...
  Widget _buildDashboard() {
    final List<Map<String, dynamic>> features = [
      ...
      },
      {
        ...
        "color2": Colors.indigo.shade300,
        "page": DoctorAppointmentsPage(token: widget.token),
      },
      {
        "title": "Profile",
        ...
        "color2": Colors.indigo.shade300,
        "page": ProfileDoctorPage(token: widget.token),
      },
    ];
            ...
            style: TextStyle(
              ...
              foreground: Paint()
                ..shader = LinearGradient(
                  colors: [Colors.indigo.shade900, AppTheme.doctorElevatedButtonbackgroundColor],
      ...
      child: GestureDetector(
        ...
        child: AnimatedContainer(
          ...
          child: Column(
            ...
            children: [
              Icon(icon, size: 26, color: isSelected ? AppTheme.doctorElevatedButtonbackgroundColor : Colors.grey),
              ...
              Text(
                ...
                style: TextStyle(
                  fontSize: 12,
                  color: isSelected ? AppTheme.doctorElevatedButtonbackgroundColor : Colors.grey,
        ...
        children: [
          AnimatedBuilder(
            ...
            builder: (context, _) {
              return Stack(
                children: [
                  Positioned(top: 90 * _controller.value, left: 30, child: _buildBlurCircle(AppTheme.doctorElevatedButtonbackgroundColor, 100)),
                  Positioned(top: 200 - 100 * _controller.value, right: 40, child: _buildBlurCircle(AppTheme.doctorElevatedButtonbackgroundColor, 100)),
                  Positioned(bottom: 0, left: 120 - 50 * _controller.value, child: _buildBlurCircle(AppTheme.doctorElevatedButtonbackgroundColor, 100)),
                ],
              );
            },
          ),
      ...
      bottomNavigationBar: Container(
        ...
        child: Row(
          children: [
            ...
            _buildBottomNavItem(Icons.calendar_today_outlined, 'Appointments', 3),
  ...
  Widget _buildStatsCards() {
    final stats = [
      {'label': "Total Patients", 'value': "124", 'color1': Colors.pink.shade400, 'color2': Colors.pinkAccent.shade100},
      {'label': "Today's Scans", 'value': "8", 'color1': Colors.purple.shade400, 'color2': Colors.indigo.shade500},
      {'label': "Pending Review", 'value': "3", 'color1': Colors.orange.shade400, 'color2': Colors.orange.shade600},
      {'label': "Completed", 'value': "115", 'color1': Colors.green.shade400, 'color2': Colors.green.shade600},
    ];
